...
console.log(`сумма чисел ${c} и ${d} равна ${add}
разность чисел ${c} и ${d} равна ${cubtract}
произведения чисел ${c} и ${d} равна ${multiplication}
частного чисел ${c} и ${d} равна ${division}`);
// g.Сложите все созданные переменные и выведите результат в консоль
let resultSum = add + cubtract + multiplication + division
console.log(`сумма всех чисел равна ${resultSum}`);
